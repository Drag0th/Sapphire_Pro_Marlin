...
#define STRING_CONFIG_H_AUTHOR "(Drag0th, Sapphire_Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Sapphire_Pro"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT {80, 80, 400, 425.64}
