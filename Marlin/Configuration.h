...
#define Z_MIN_ENDSTOP_HIT_STATE HIGH // I'm using Optical Endstop
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 320, 1600, 1569.6 } // Calibrated stock extruder - 402 (Hemera stock 409, 392.40 - after calibration)
