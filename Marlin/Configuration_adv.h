...
#define ADVANCE_K {0.023} // (mm) Compression length per 1mm/s extruder speed, per extruder
#else
#define ADVANCE_K 0.023 // (mm) Compression length applying to all extruders
#endif
